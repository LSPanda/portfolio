...
window.onload = function() {
    ...
    var r = Raphael( "holder", 260, 400);


    // Creates donut chart with center at 320, 200,
    // radius 100 and data: [55, 20, 13, 32, 5, 1, 2]
    var pie = r.piechart(130, 120, 100, [88, 79, 82, 58, 56, 18, 81, 92, 44], {donut : true, legend: ["HTML5", "CSS3", "Sass", "JavaScript", "jQuery", "PHP", "Photoshop", "Illustrator", "InDesign"], legendpos: "south"});
    ...
    pie.hover(function () {
        ...
        pie.each(function() {
           if(this.sector.id === that.id) {
            console.log(pie)
               tooltip = r.text(130, 120, this.sector.value.value).attr({"font-size": 35, "fill":"#000"});
           }
        });
